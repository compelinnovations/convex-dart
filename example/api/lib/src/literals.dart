...
class $1Literal implements Literal {
  const $1Literal();
  const $1Literal.validate(dynamic value)
    : assert(value == 1.0, r"Value mismatch for $1Literal");
...
class $2Literal implements Literal {
  const $2Literal();
  const $2Literal.validate(dynamic value)
    : assert(value == 2.0, r"Value mismatch for $2Literal");
...
class $3Literal implements Literal {
  const $3Literal();
  const $3Literal.validate(dynamic value)
    : assert(value == 3.0, r"Value mismatch for $3Literal");
